...
- [Player-cards: facial likeness blocker + plan](project_player_cards_facial_likeness.md) — BREAKTHROUGH via FLUX.1 Kontext (image-editing model, Tier 4): likeness+full body+style all worked in one shot
