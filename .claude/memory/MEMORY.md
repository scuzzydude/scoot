...
- [Player-cards: facial likeness blocker + plan](project_player_cards_facial_likeness.md) — SOLVED via FLUX.1 Kontext (Tier 4): likeness+full body+cartoon face all working, ~$0.02-0.03/card, no training needed
