...
- [Player-cards: facial likeness blocker + plan](project_player_cards_facial_likeness.md) — Tier 1 (Zero checkpoint) negative; Tier 2 LoRA pilot paused on source photos, see art/lora_training/brandon/README.txt
