...
- [Player-cards: facial likeness blocker + plan](project_player_cards_facial_likeness.md) — front card feature-complete as of card-review-20 (QR/hash mark added); next up is the back card (stats/art unstarted); Shipp still blocked
