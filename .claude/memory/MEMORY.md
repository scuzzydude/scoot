...
- [Reminder from 2026-09-03: check Brevo SMTP activation, swap relay off Zoho, cancel Zoho](project_mail_brevo_activation_pending.md) — self-hosted mail live; outbound still relays via Zoho until Brevo activates; steps inside; delete when done
