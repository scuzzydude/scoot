...
- [Player-cards: facial likeness blocker + plan](project_player_cards_facial_likeness.md) — 23-PERSON BATCH confirmed at scale, zero failures, crest true white (2 bugs fixed); data still placeholder, backs not started
