...
- [Player-cards: facial likeness blocker + plan](project_player_cards_facial_likeness.md) — Kontext (Tier 4) works for likeness+body+style; hair drifts under style push, needs mask+composite (not prompting) — same fix as jersey
