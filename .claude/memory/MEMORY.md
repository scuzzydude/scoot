...
- [Player-cards: facial likeness blocker + plan](project_player_cards_facial_likeness.md) — 13 approaches tried, all negative; pose ControlNet reliability now leading suspect, check-in point reached
