...
- [Player-cards: facial likeness blocker + plan](project_player_cards_facial_likeness.md) — Kontext (Tier 4): likeness+body+cartoon face+hair all fixed (mask+visual-reference technique). Jersey compositing next
