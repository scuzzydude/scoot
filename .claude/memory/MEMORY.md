...
- [Brevo relay live; Zoho cancel pending](project_mail_brevo_activation_pending.md) — relay/SPF/sync all done 2026-09-03; ask Brandon if Zoho is cancelled, then delete; mailbox pw leaked in git history, rotate
