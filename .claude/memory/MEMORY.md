...
- [Player-cards: facial likeness blocker + plan](project_player_cards_facial_likeness.md) — USO/FLUX works in headshot framing; 3 full-body attempts all lost identity identically; try waist-up framing next
