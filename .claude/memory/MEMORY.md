...
- [Player-cards: facial likeness blocker + plan](project_player_cards_facial_likeness.md) — PIPELINE CONFIRMED on 2 subjects (Brandon, Cleo), real Fonde crest centered w/ mesh texture: likeness+body+face+hair+jersey all working, ~$0.02-0.03/card
