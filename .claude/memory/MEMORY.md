...
- [Player-cards: facial likeness blocker + plan](project_player_cards_facial_likeness.md) — PILOT DONE: anime has real repeated whitewashing bias (wrong eye colors etc), comic/graphic recommended instead; Brandon hasn't picked yet
