...
- [Player-cards: facial likeness blocker + plan](project_player_cards_facial_likeness.md) — USO/FLUX works in headshot framing, lost on full-body push; untested lever = full-body subject photo
