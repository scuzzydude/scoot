...
- [Player-cards: facial likeness blocker + plan](project_player_cards_facial_likeness.md) — FIRST COMPLETE CARD FRONT built (Rocket Man/Cleo, BADASS, real template); data still placeholder, art-only pass
