...
- [Player-cards: facial likeness blocker + plan](project_player_cards_facial_likeness.md) — CARD FRONT template fixed (crest white, arms not cropped, edge dots inset); Rocket Man/Cleo, BADASS; data still placeholder
