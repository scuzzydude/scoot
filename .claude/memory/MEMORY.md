...
- [Player-cards: facial likeness blocker + plan](project_player_cards_facial_likeness.md) — art pipeline works, likeness doesn't (10 tries); research says checkpoint mismatch is why; plan = try Animagine Zero, then per-subject LoRA
