...
- [Player-cards: facial likeness blocker + plan](project_player_cards_facial_likeness.md) — PIPELINE CONFIRMED, crest+framing+expression (BADASS picked) all working; any prompt change needs a per-subject hair/mustache re-fix, ~$0.02-0.03/card
