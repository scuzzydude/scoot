...
- [Player cards linked to SMS/webchat](project_card_link_sms_webchat.md) — "my card"/claim-by-code/self-edit profile, verified live via real Twilio MMS + webchat; 26/31 linked, 5 still unlinked as of 2026-09-08 (live card_links count)
...
- [Claude Code runs ON prod dreamlab, not WSL](infra_claude_runs_on_dreamlab.md) — dreamlab is the AUTHORITATIVE checkout; a second, stale (2026-05-28), credential-free checkout exists on the Steve host (corrected 2026-09-08); when in /home/brandon/scoot, the host IS prod; no SSH-to-deploy; edits go straight to prod; hostname renamed from steve 2026-07-27 (work-LAN name collision)
...
- [Guest cards 13–24 added to set 1 (2026-09-16)](project_card_guests_13_24.md) — printed 34-2026-1, card-review-46, own release folder beside frozen set 1; rows live in player_cards
