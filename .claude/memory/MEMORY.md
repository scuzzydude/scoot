...
- [Player-cards: facial likeness blocker + plan](project_player_cards_facial_likeness.md) — PIPELINE COMPLETE for single subject incl. real Fonde crest (crisp collar, mesh texture): likeness+body+face+hair+jersey all working, ~$0.02-0.03/card
